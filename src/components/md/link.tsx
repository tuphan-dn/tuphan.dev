  ...
  const comp = useMemo(() => {
    ...
    return (
      <div className="relative group">
        ...
        <div className="absolute left-0 w-full rounded-b-box p-4 transition-all -bottom-8 group-hover:bottom-0 opacity-0 group-hover:opacity-100 flex flex-col gap-1 bg-gradient-to-t from-base-300 to-base-300/10 backdrop-blur text-base-content">
